...
function runStars(timeNow) {
    ...
    for (let i = 0; i < starsNumber; i++) {
        ...
        // reposition stars the other side of the screen when they move of either side of the screen
        ...
        // reposition stars the top/bottom side of the screen when they move of either from the top or bottom
