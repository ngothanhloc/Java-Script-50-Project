...
function getRandomCat() {
    fetch('https://aws.random.cat/meow').then((response) => response.json()).then((responseData) => {
        cat.innerHTML = `<img src="${responseData.file}">`
    });
}
// ----------------------------------------------------Get Random Fox Images
function getRandomFox() {
    fetch('https://randomfox.ca/floof/').then((response) => response.json()).then((responseData) => {
...
function getRandomDog() {
    fetch('https://random.dog/woof.json').then((response) => response.json()).then((responseData) => {
